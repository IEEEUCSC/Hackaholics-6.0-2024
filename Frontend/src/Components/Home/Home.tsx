    ...
    return (
        <motion.main
            ...
            <motion.div variants={itemVariants} className="flex flex-col md:flex-row justify-center items-center">
                <motion.div variants={itemVariants} className="mt-3 md:mt-1 lg:mt-10 md:mr-4">
                    <div className="hover:text-primary text-secondary font-bold">
                        <a href="#_" className="relative inline-flex items-center justify-start px-5 py-3 overflow-hidden font-medium transition-all bg-secondary rounded-full hover:bg-purple-100 group">
                            ...
                            <span className="relative w-full text-left text-orange-100 transition-colors duration-200 ease-in-out group-hover:text-secondary font-bold tracking-wide">Delegate Booklet</span>
                        </a>
                    </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="mt-3 md:mt-1 lg:mt-10 md:mr-4">
                    <div className="hover:text-primary text-secondary font-bold">
                        <a href="https://github.com/IEEEUCSC" className="relative inline-flex items-center justify-start inline-block p-6 px-6 py-3 overflow-hidden font-medium rounded-full group">
                            ...
                            <span className="relative w-full text-left text-orange-100 transition-colors duration-200 ease-in-out group-hover:text-secondary tracking-wide font-bold">Register Now</span>
